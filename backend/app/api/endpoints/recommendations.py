...
async def get_trending(
    ...
    return await recommendation_service.get_trending_movies(db, limit=limit, include_synthetic=include_synthetic)
...
async def get_popular(
    ...
    return await recommendation_service.get_popular_movies(db, limit=limit, include_synthetic=include_synthetic)
...
async def get_recently_added(
    ...
    return await recommendation_service.get_recently_added_movies(db, limit=limit, include_synthetic=include_synthetic)
